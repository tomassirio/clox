...
ParseRule rules[] = {
        ...
        [TOKEN_LEFT_BRACE]          = {grouping, NULL, PREC_NONE},
        [TOKEN_RIGHT_BRACE]         = {grouping, NULL, PREC_NONE},
        [TOKEN_COMMA]               = {grouping, NULL, PREC_NONE},
        [TOKEN_DOT]                 = {grouping, NULL, PREC_NONE},
        [TOKEN_MINUS]               = {unary,    binary,PREC_TERM},
        [TOKEN_PLUS]                = {grouping, binary,PREC_TERM},
        ...
        [TOKEN_EOF]                 = {grouping, NULL, PREC_NONE},
};
